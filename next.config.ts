    ...
    return [
      {
        ...
        headers: [
          ...
          {
            // `unsafe-inline`/`unsafe-eval` on scripts are required by Next's
            // hydration payload and dev tooling; this still blocks third-party
            // origins, plugins, and inline event handlers.
